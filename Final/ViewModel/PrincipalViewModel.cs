...
namespace Final.ViewModel
{
    public class PrincipalViewModel : INotifyPropertyChanged
    {
        ...
        public PrincipalViewModel()
        {
            ...
            IsEnabledBuscarP = true;
            IsEnabledCancelarBuscarp = true;
            ...
            VerProductos();
            BuscarP = new CommandBase(BuscarElProducto, () => IsEnabledModificar == true);
            CancelarBuscarp = new CommandBase(CancelarBuscarProducto, () => IsEnabledModificar == true);
        }
        ...
        private bool _isEnabledBuscarP;
        public bool IsEnabledBuscarP
        {
            get { return _isEnabledBuscarP; }
            set
            {
                if (_isEnabledBuscarP == value)
                {
                    return;
                }
                _isEnabledBuscarP = value;
                OnPropertyChange("IsEnabledBuscarP");
            }
        }

        private bool _isEnabledCancelarBuscarp;
        public bool IsEnabledCancelarBuscarp
        {
            get { return _isEnabledCancelarBuscarp; }
            set
            {
                if (_isEnabledCancelarBuscarp == value)
                {
                    return;
                }
                _isEnabledCancelarBuscarp = value;
                OnPropertyChange("IsEnabledCancelarBuscarp");
            }
        }
